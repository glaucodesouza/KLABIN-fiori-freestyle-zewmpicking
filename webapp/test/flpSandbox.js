		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Picking",
									"targetURL": "#brcomklabinzewmpicking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomklabinzewmpicking-display": {
								"semanticObject": "brcomklabinzewmpicking",
								"action": "display",
								"description": "Picking",
								"title": "Picking",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.klabin.zewmpicking2",
									"url": sap.ui.require.toUrl("br/com/klabin/zewmpicking2")
								}
							}
						}
					}
